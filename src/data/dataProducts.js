...
const dataProducts = [
  {
    ...
    txt: "Projet 2 de la formation développeur front-end OpenClassrooms: Front-end site de réservation immo.",
  ...
  },
  {
    ...
    txt: "Projet 3 de la formation développeur front-end OpenClassrooms: Front-end site de réservation de restaurants.",
  ...
  },
  {
    ...
    txt: "Projet 4 de la formation développeur front-end OpenClassrooms: Landing page inscription.",
  ...
  },
  {
    ...
    txt: "Projet 6 de la formation développeur front-end OpenClassrooms: SPA pour agence de photographe, fonctions de tri et filtres.",
  ...
  },
  {
    ...
    txt: "Projet 7 de la formation développeur front-end OpenClassrooms: Implémentation de fonctions de recherche.",
  ...
  },
  {
    ...
    txt: "Projet 9 de la formation développeur front-end OpenClassrooms: Implémenter les tests sur un code pré-existant.",
  ...
  },
  {
    ...
    txt: "Projet 10 de la formation développeur front-end OpenClassrooms: Maquettage, gestion de projet.",
  ...
  },
  {
    ...
    txt: "Projet 11 de la formation développeur front-end OpenClassrooms: Front-end d'un site de locations meublées.",
  ...
  },
  {
    ...
    txt: "Projet 12 de la formation développeur front-end OpenClassrooms: Dashboard pour une application de coaching sportif.",
